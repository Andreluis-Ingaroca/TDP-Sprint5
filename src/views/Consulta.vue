      ...
      <div class="pt-5" align="center" justify="center">
        <v-card v-if="hide == false" color="#55B4B0" rounded="xl" class="mx-10" max-width="57%">
          <v-row>
            ...
            <div>
              <v-img src="https://us.123rf.com/450wm/sylverarts/sylverarts2008/sylverarts200800157/153123800-s%C3%ADmbolo-de-caduceo-hecho-con-alas-de-p%C3%A1jaro-y-serpientes-venenosas-ilustraci%C3%B3n-vectorial-conceptual-.jpg?ver=6" max-height="400" max-width="400"></v-img>
            </div>
          </v-row>
        </v-card>
      </div>
